...
urlpatterns = [
    ...
    path('public/pairing-draw', views.public_pairing_draw, name='public_pairing_draw'),
    ...
    path('pairing/clear_scoring_judges/<int:round_num>', views.clear_scoring_judges, name='clear_scoring_judges'),
